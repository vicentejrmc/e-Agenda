...
namespace eAgenda.WebApp.Models
{
    public abstract class FormularioTarefaViewModel
    {
        ...
        public class CadastrarTarefaViewModel : FormularioTarefaViewModel
        {
            ...
            public CadastrarTarefaViewModel(string titulo, string prioridade, DateTime dataCriacao, string statusConcluida, double percentualConcluida, List<Item> itens, DateTime? dataConclusao = null) : this()
            {
                Titulo = titulo;
